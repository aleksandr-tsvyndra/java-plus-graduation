...
import ru.practicum.feignClient.AdminUserServiceClient;
...
public class ParticipationRequestServiceImpl implements RequestService {
    ...
    private final PublicEventServiceClient publicEventServiceClient;

    @Override
    public List<ParticipationRequestDto> getEventRequests(Long userId, Long eventId) {
        EventShortDto event = publicEventServiceClient.getEventShortDtoByIdClient(eventId);
    ...
    public EventRequestStatusUpdateResult updateRequestStatus(Long userId, Long eventId,
        ...
        EventFullDto event = publicEventServiceClient.getEventFullDtoByIdClient(eventId);
        if (!event.getInitiator().getId().equals(userId)) {
            throw new NotFoundException("Event with id=" + eventId + " not found for user with id=" + userId);
        }
    ...
    public List<ParticipationRequestDto> getUserRequests(Long userId) {
        adminUserServiceClient.getUserById(userId);
    ...
    public ParticipationRequestDto createRequest(Long userId, Long eventId) {
        UserShortDto user = adminUserServiceClient.getUserShortDtoById(userId);
        EventFullDto event = publicEventServiceClient.getEventFullDtoByIdClient(eventId);
